...
use crate::{shell::SurfaceData, window_map::{Kind, WindowMap}};
...
pub fn draw_top_window<R, E, F, T>(
    renderer: &mut R,
    frame: &mut F,
    ...
    T: Texture + 'static,
{
    ...
    window_map.with_top_window(|toplevel_surface, mut initial_place, &bounding_box| {
